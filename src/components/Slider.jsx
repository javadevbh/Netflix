...
const Slider = () => {
  ...
  return (
    <section className="w-full h-[30rem] overflow-hidden rounded-3xl relative">
      ...
      />
      <div className="absolute flex flex-col justify-between top-0 w-full h-full bg-black/30 md:bg-transparent md:shadow-y-sm sm:p-8 py-6 px-2">
        <div className="grid gap-4 sm:gap-0 sm:flex sm:space-x-3 space-x-reverse justify-center sm:justify-start items-center text-slate-200">
          <p className="bg-black/30 py-2 px-4 rounded-full mx-auto sm:mx-3">
            10px / قسمت ها
          </p>
