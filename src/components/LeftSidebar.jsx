...
const LeftSidebar = () => {
  return (
    <div className="fixed hover:translate-x-0 transition-all duration-200 z-50 -translate-x-20 xl:translate-x-0 bg-white top-0 left-0 w-20 shadow-md h-screen flex items-center justify-center">
      <div className="flex flex-col items-center justify-around h-4/5">
        ...
        <div className="absolute xl:-right-4 -right-7 shadow-sm w-7 xl:w-4 flex justify-center items-center h-8 bg-white rounded-r-full cursor-pointer">
